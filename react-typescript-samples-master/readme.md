...
GraphQL+Express/MongoDB/Mongoose (express-graphql)
GraphQL+SQLite(graphql-nodejs-newsfeed-master)
"Instant" GraphQL Server (https://www.reindex.io)
Flux (flux-master)
Redux+Angular2 (tbd)
ReactJS+TypeScript (react-typescript-samples-master)

The goal of this project is to provide a set of simple samples, providing and 
step by step guide to start working with React and Typescript. Characteristics:
...
4. Open a command shell and cd to the root directory of this repo on your machine  
